...
1. **First Notice:** A warning letter. You have time to fix the issue (usually 48 hours to 30 days depending on the issue).
2. **Second Notice:** A final warning reminder.
3. **Third Notice:** A **$50.00 fine** is assessed.
4. **Fourth - Sixth Notices:** Fines double with each notice, up to **$400.00**.
5. **Continuing Violations:** An additional $100.00 per month accrues until fixed.
